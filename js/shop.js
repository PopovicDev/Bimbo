...
let ar1 = [];
let ar2 = [];
fetch('https://cors-anywhere.herokuapp.com/https://bimbo-company-3e6f6ed5b564.herokuapp.com/api/recipient_id_get').then(response=>response.json()).then(data=>rec_id = data);
fetch('https://cors-anywhere.herokuapp.com/https://bimbo-company-3e6f6ed5b564.herokuapp.com/api/delivery_id_get').then(response=>response.json()).then(data=>del_id = data);
...
async function LoadShippingAddress(){
    ...
    if(localStorage.getItem("recipient_id") !== null){
        fetch('https://cors-anywhere.herokuapp.com/https://bimbo-company-3e6f6ed5b564.herokuapp.com/api/get-recid',{
            method:'POST',
            headers:{
        ...
        await fetch('https://cors-anywhere.herokuapp.com/https://bimbo-company-3e6f6ed5b564.herokuapp.com/api/db-fill-SA').then(response=>response.json()).then(data=>inputz = data);
        ...
        fetch('https://cors-anywhere.herokuapp.com/https://bimbo-company-3e6f6ed5b564.herokuapp.com/api/recipient_id_file_post',{
            method:'POST',
            headers:{
                'Content-Type': 'application/json'
            },
...
if(path == 'checkout.html'){
    save_info.onclick = () => {
        ...
        if(b == false){
            fetch('https://cors-anywhere.herokuapp.com/https://bimbo-company-3e6f6ed5b564.herokuapp.com/api/recipient_id_post',{
                method:'POST',
                headers:{
                    'Content-Type': 'application/json'
                },
    ...
    cancel_info.onclick = () => {
        fetch('https://cors-anywhere.herokuapp.com/https://bimbo-company-3e6f6ed5b564.herokuapp.com/api/recipient_id_cancel_post',{
            method:'POST',
            headers:{
                'Content-Type': 'application/json'
            },
...
function ProceedCheck(){
    ...
    if((b == false && credit_card.dataset.selected == "true" && cart_number.innerHTML != "0") || (b == false && cash_on_delivery.dataset.selected == "true" && cart_number.innerHTML != "0")){
        ...
        fetch('https://cors-anywhere.herokuapp.com/https://bimbo-company-3e6f6ed5b564.herokuapp.com/api/payment_method', {
            method: 'POST',
            headers:{
                'Content-Type': 'application/json'
            },
...
function Proceeded(){
    ...
    if(localStorage.length < 2){
        ...
        items.forEach(element=>{
            fetch('https://cors-anywhere.herokuapp.com/https://bimbo-company-3e6f6ed5b564.herokuapp.com/api/delivery_id_post',{
                method:'POST',
                headers:{
                    'Content-Type': 'application/json'
                },
        ...
        fetch('https://cors-anywhere.herokuapp.com/https://bimbo-company-3e6f6ed5b564.herokuapp.com/api/delivery_id_file_post',{
            method:'POST',
            headers:{
                'Content-Type': 'application/json'
            },
